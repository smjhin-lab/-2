...
namespace IndoorSim.EditorTools
{
    public static class SimulatorMenu
    {
        ...
        public static void GenerateAll()
        {
            ...
            // 1. 에스컬레이터 자동 페인트칠
            EscalatorBelt[] escalators = UnityEngine.Object.FindObjectsByType<EscalatorBelt>(FindObjectsInactive.Exclude, FindObjectsSortMode.None);
            ...
            MeshRenderer[] allMeshes = UnityEngine.Object.FindObjectsByType<MeshRenderer>(FindObjectsInactive.Exclude, FindObjectsSortMode.None);
            ...
            // 3. 엘리베이터 자동 페인트칠
            ElevatorCab[] elevators = UnityEngine.Object.FindObjectsByType<ElevatorCab>(FindObjectsInactive.Exclude, FindObjectsSortMode.None);
        ...
        public static void GenerateCustomSafePath(Transform root)
        {
            ...
            obj0.transform.position = new Vector3(88.18f, -0.5f, -12.82f);
            obj0.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj0.transform.localScale = new Vector3(47.30649f, 1f, 1f);
            ...
            obj1.transform.position = new Vector3(78.44f, -6.49f, -17.45f);
            obj1.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj1.transform.localScale = new Vector3(1f, 1f, 9.547979f);
            ...
            obj2.transform.position = new Vector3(78.88f, 5.52f, 5.483f);
            obj2.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj2.transform.localScale = new Vector3(5.7188f, 1f, 1f);
            ...
            obj3.transform.position = new Vector3(59.3f, -6.49f, -12.82f);
            obj3.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj3.transform.localScale = new Vector3(-127.1967f, 1f, 1f);
            ...
            obj4.transform.position = new Vector3(35.64f, -6.49f, 19.3f);
            obj4.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj4.transform.localScale = new Vector3(1f, 1f, 15.79454f);
            ...
            obj5.transform.position = new Vector3(79.38f, 5.52f, -0.08f);
            obj5.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj5.transform.localScale = new Vector3(1f, 1f, 46.3051f);
            ...
            obj6.transform.position = new Vector3(110.95f, -0.5f, -17.53f);
            obj6.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj6.transform.localScale = new Vector3(1f, 1f, 9.542688f);
            ...
            obj7.transform.position = new Vector3(-41.63f, -12.49f, 1.94f);
            obj7.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj7.transform.localScale = new Vector3(2.840442f, 1f, 2.997191f);
            ...
            obj8.transform.position = new Vector3(106.34f, -0.5f, 7f);
            obj8.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj8.transform.localScale = new Vector3(12.347f, 1f, 1f);
            ...
            obj9.transform.position = new Vector3(113.78f, -0.5f, 28.23f);
            obj9.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj9.transform.localScale = new Vector3(7.570398f, 1f, 1f);
            ...
            obj10.transform.position = new Vector3(109.95f, -6.49f, 15.82f);
            obj10.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj10.transform.localScale = new Vector3(1f, 1f, 8.53961f);
            ...
            obj11.transform.position = new Vector3(89.77f, 5.52f, 20.01f);
            obj11.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj11.transform.localScale = new Vector3(1f, 1f, 5.009336f);
            ...
            obj12.transform.position = new Vector3(87.68f, -0.5f, 18.28f);
            obj12.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj12.transform.localScale = new Vector3(46.47272f, 1f, 1f);
            ...
            obj13.transform.position = new Vector3(76.54f, -0.5f, -0.36f);
            obj13.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj13.transform.localScale = new Vector3(1f, 1f, 42.49714f);
            ...
            obj14.transform.position = new Vector3(-40.26f, -12.49f, -2.58f);
            obj14.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj14.transform.localScale = new Vector3(1.030344f, 1f, 4.005781f);
            ...
            obj15.transform.position = new Vector3(-26.17f, -6.49f, -0.24f);
            obj15.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj15.transform.localScale = new Vector3(9.725f, 1f, 1f);
            ...
            obj16.transform.position = new Vector3(112.48f, -6.49f, 18.7f);
            obj16.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj16.transform.localScale = new Vector3(5.4308f, 1f, 1f);
            ...
            obj17.transform.position = new Vector3(36f, -0.5f, 38.46f);
            obj17.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj17.transform.localScale = new Vector3(1f, 1f, 7.558958f);
            ...
            obj18.transform.position = new Vector3(89.51f, -6.49f, -17.45f);
            obj18.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj18.transform.localScale = new Vector3(1f, 1f, 9.547979f);
            ...
            obj19.transform.position = new Vector3(33.47f, -0.46f, -0.14f);
            obj19.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj19.transform.localScale = new Vector3(96.22066f, 0.9596778f, 0.92929f);
            ...
            obj20.transform.position = new Vector3(42.94f, -6.49f, -0.27f);
            obj20.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj20.transform.localScale = new Vector3(-131.3007f, 1f, 1f);
            ...
            obj21.transform.position = new Vector3(0.08f, -6.49f, 19.3f);
            obj21.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj21.transform.localScale = new Vector3(1f, 1f, 15.79454f);
            ...
            obj22.transform.position = new Vector3(110.25f, -0.5f, 23.91f);
            obj22.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj22.transform.localScale = new Vector3(1f, 1f, 11.99302f);
            ...
            obj23.transform.position = new Vector3(100.66f, -6.49f, 16.9f);
            obj23.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj23.transform.localScale = new Vector3(1f, 1f, 10.3946f);
            ...
            obj24.transform.position = new Vector3(95.75f, -0.5f, 5.37f);
            obj24.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj24.transform.localScale = new Vector3(9.6285f, 1f, 3.2383f);
            ...
            obj25.transform.position = new Vector3(99.42f, -0.5f, -5.61f);
            obj25.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj25.transform.localScale = new Vector3(1.791341f, 1f, 2.6544f);
            ...
            obj26.transform.position = new Vector3(100.52f, -6.49f, -17.45f);
            obj26.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj26.transform.localScale = new Vector3(1f, 1f, 9.547979f);
            ...
            obj27.transform.position = new Vector3(-29.46f, -12.49f, 2.11f);
            obj27.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj27.transform.localScale = new Vector3(3.330794f, 1f, 3.2925f);
            ...
            obj28.transform.position = new Vector3(23.91f, -0.5f, 38.46f);
            obj28.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj28.transform.localScale = new Vector3(1f, 1f, 7.558958f);
            ...
            obj29.transform.position = new Vector3(59.05f, -6.49f, 11.83f);
            obj29.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj29.transform.localScale = new Vector3(-115.6557f, 1f, 1f);
            ...
            obj30.transform.position = new Vector3(-9.23f, -12.49f, 0.01f);
            obj30.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj30.transform.localScale = new Vector3(1f, 1f, 10.01434f);
            ...
            obj31.transform.position = new Vector3(83.1f, 5.52f, -10.64f);
            obj31.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj31.transform.localScale = new Vector3(1f, 1f, 1f);
            ...
            obj32.transform.position = new Vector3(88.07f, -6.49f, -6.6f);
            obj32.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj32.transform.localScale = new Vector3(1f, 1f, 12.88665f);
            ...
            obj33.transform.position = new Vector3(2.37f, -6.49f, 15.93f);
            obj33.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj33.transform.localScale = new Vector3(4.907752f, 1f, 1f);
            ...
            obj34.transform.position = new Vector3(4f, -0.5f, 42f);
            obj34.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj34.transform.localScale = new Vector3(115f, 1f, 1.102626f);
            ...
            obj35.transform.position = new Vector3(81.511f, 5.52f, 5.59f);
            obj35.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj35.transform.localScale = new Vector3(0.8704348f, 1f, 3.0208f);
            ...
            obj36.transform.position = new Vector3(106.34f, -0.5f, -2.9f);
            obj36.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj36.transform.localScale = new Vector3(12.347f, 1f, 1f);
            ...
            obj37.transform.position = new Vector3(24.09f, -6.49f, 19.3f);
            obj37.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj37.transform.localScale = new Vector3(1f, 1f, 15.79454f);
            ...
            obj38.transform.position = new Vector3(-31.16f, -12.49f, 1.433f);
            obj38.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj38.transform.localScale = new Vector3(1.030344f, 1f, 5.384635f);
            ...
            obj39.transform.position = new Vector3(11.92f, -6.49f, 19.3f);
            obj39.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj39.transform.localScale = new Vector3(1f, 1f, 15.79454f);
            ...
            obj40.transform.position = new Vector3(88.07f, -6.49f, 5.78f);
            obj40.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj40.transform.localScale = new Vector3(1f, 1f, 12.88665f);
            ...
            obj41.transform.position = new Vector3(0f, -0.5f, 41.64f);
            obj41.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj41.transform.localScale = new Vector3(10.38f, 1f, 13.6217f);
            ...
            obj42.transform.position = new Vector3(17.7f, -0.5f, 15.25f);
            obj42.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj42.transform.localScale = new Vector3(1f, 1f, 75.55269f);
            ...
            obj43.transform.position = new Vector3(100.46f, -0.5f, -0.5699987f);
            obj43.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj43.transform.localScale = new Vector3(1f, 1f, 42.172f);
            ...
            obj44.transform.position = new Vector3(2.77f, -12.49f, -4.21f);
            obj44.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj44.transform.localScale = new Vector3(90.71478f, 1f, 1f);
            ...
            obj45.transform.position = new Vector3(4.7f, -6.49f, 1.68f);
            obj45.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj45.transform.localScale = new Vector3(1f, 1f, 29.21077f);
            ...
            obj46.transform.position = new Vector3(2.77f, -12.49f, 4.2f);
            obj46.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj46.transform.localScale = new Vector3(90.71478f, 1f, 1f);
            ...
            obj47.transform.position = new Vector3(12.39f, -0.5f, 38.46f);
            obj47.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj47.transform.localScale = new Vector3(1f, 1f, 7.558958f);
            ...
            obj48.transform.position = new Vector3(-27.98f, -12.49f, -0.94f);
            obj48.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj48.transform.localScale = new Vector3(85.03561f, 1f, 1f);
            ...
            obj49.transform.position = new Vector3(-30.7f, -6.49f, -0.57f);
            obj49.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj49.transform.localScale = new Vector3(1.0727f, 1f, 8.784531f);
            ...
            obj50.transform.position = new Vector3(67.51f, -0.5f, 0.22f);
            obj50.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj50.transform.localScale = new Vector3(1f, 1f, 45.0817f);
            ...
            obj51.transform.position = new Vector3(89.39f, -6.49f, 16.9f);
            obj51.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj51.transform.localScale = new Vector3(1f, 1f, 10.3946f);
            ...
            obj52.transform.position = new Vector3(67.51f, -6.49f, -0.36f);
            obj52.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj52.transform.localScale = new Vector3(1f, 1f, 45.26593f);
            ...
            obj53.transform.position = new Vector3(89.55f, -0.5f, -17.53f);
            obj53.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj53.transform.localScale = new Vector3(1f, 1f, 9.542688f);
            ...
            obj54.transform.position = new Vector3(116.558f, 5.52f, 18.581f);
            obj54.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj54.transform.localScale = new Vector3(2.671269f, 1f, 1f);
            ...
            obj55.transform.position = new Vector3(111.32f, -6.49f, -17.45f);
            obj55.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj55.transform.localScale = new Vector3(1f, 1f, 9.547979f);
            ...
            obj56.transform.position = new Vector3(78.44f, -6.49f, 16.9f);
            obj56.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj56.transform.localScale = new Vector3(1f, 1f, 10.3946f);
            ...
            obj57.transform.position = new Vector3(89.22f, 5.52f, 17.84f);
            obj57.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
            obj57.transform.localScale = new Vector3(56.35821f, 1f, 1f);
